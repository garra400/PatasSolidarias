...
router.post('/login', async (req, res) => {
  try {
    ...
    // Gerar token JWT com TODAS as permissões do banco de dados
    ...
    console.log('🔐 Token gerado com isAdmin:', user.isAdmin || false);

    // Determinar o role baseado em isAdmin
    const userRole = user.isAdmin ? 'admin' : (user.role || user.tipo || 'user');
...
router.post('/confirm-email', async (req, res) => {
  try {
    ...
    // Gerar token JWT para login automático com TODAS as permissões
